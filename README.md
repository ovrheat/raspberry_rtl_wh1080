...
Remember: the sensor group sends its data every 48 seconds, so don't pretend to see data immediately, probably it will take some tenth of seconds. Keep this in mind especially at the start of the even hours, because of the 3-4 minutes of silence before the time signal, as explained later.


To test now we need to know on what frequencies your WH1080 is transmitting. This station comes in (at least) three different TX frequencies models: 868 Mhz, 433 Mhz and 915 Mhz.
