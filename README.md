...
[RaspberryPi] (https://www.raspberrypi.org/)' specific rtl-sdr solution to decode [Fine Offset WH1080 weather station] (http://www.foshk.com/weather_professional/wh1080.htm) RF data signal and [BMP085] (https://www.google.com/search?q=BMP085)/[BMP180] (https://www.google.com/search?q=BMP180) barometric sensor (using an 'hacked' [rtl_433] (https://github.com/merbanan/rtl_433) snapshot).
------------------------------
...
- being a MUCH more stable solution, there's no need to pass data to a datalogger script by using such a 'data file transfer' method. You can grab json data 'on the fly' from the program's output. As a result, the Rasp SDcard is much less stressed and its theoretical life is much longer.  
