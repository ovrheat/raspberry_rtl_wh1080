...
RaspberryPi's [rtl_433] (https://github.com/merbanan/rtl_433) specific port to decode both Fine Offset WH1080 weather station and BMP085/BMP180 barometric sensor.
------------------------------
...
- [Fine Offset WH1080] (http://www.foshk.com/weather_professional/wh1080.htm) is a relatively low-cost weather station and is also sold rebranded with many names: Watson W-8681, Digitech XC0348 Weather Station, PCE-FWS 20, Elecsa AstroTouch 6975, Froggit WH1080 and many others.
It's composed by an indoor touchscreen control panel and an outdoor wireless sensors group. The latter sends periodically data packets to the indoor console, containing weather measurements about wind speed, wind direction, temperature, humidity and rain. It periodically sends also time signals (DCF77 and maybe other time signals standards) to keep the console perfectly synced with an atomic clock.
...
As this work is derived from rtl_433, the same compiling and install procedures applies, but because of the barometric sensor you need some extra operation:
