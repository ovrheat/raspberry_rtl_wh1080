...
- **The receiver dongle it's almost plug & play!** No wiring, just insert the dongle in the Rasp USB port (and the mini antenna on the dongle :) ) 
...
--
You are now done and ready to test. If not already done, connect the mini antenna to the dongle (..doh!). 
